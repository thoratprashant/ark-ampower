...
export const simpleCandlestickChartOpts: Partial<ChartOptions> = {
  chart: {
    height: 400,
    zoom: {
      enabled: false
...
export const categoryChartChartOpts: Partial<ChartOptions> = {
  series: [{
    name: 'candle',
    data: [{
...
export const candlestickLineChartOpts: Partial<ChartOptions> = {
  series: [{
    name: 'Line',
    type: 'line',
    data: [{
...
export const comboChart: Partial<ChartOptions> = {
  chart: {
...
export const combobarChart: Partial<ChartOptions> = {
  chart: {
    height: 160,
    type: 'bar',
    toolbar: {
