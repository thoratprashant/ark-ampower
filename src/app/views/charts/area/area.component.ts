...
export class AreaComponent {
  ...
  basicChartOpts: Partial<ChartOptions> = {
    chart: {
      height: 380,
      type: 'area',
      zoom: {
  ...
  splineChartOpts: Partial<ChartOptions>  = {
    chart: {
      height: 380,
      type: 'area',
      zoom: {
  ...
  dateTimeChartChartOpts: Partial<ChartOptions> = {
    annotations: {
      yaxis: [{
        y: 30,
        borderColor: '#999',
  ...
  NegativeValuesChartOpts: Partial<ChartOptions> = {
    chart: {
      height: 380,
      type: 'area',
      zoom: {
  ...
  stackedChartOpts:  Partial<ChartOptions> = {
    series: [
      {
        name: 'South',
...
timeSeriesChartOpts: Partial<ChartOptions> = {
    series: [{
      name: 'PRODUCT A',
      data: dataSet[0]
    }, {
 ...
 nullValuesChartOpts: Partial<ChartOptions> = {
    colors: ["#39afd1"],
    series: [{
        name: 'Network',
        data: [{
