...
import { DataTableItems, type DataTableItemsType } from './data'
...
@Component({
  ...
  standalone: true,
  imports: [NgbPaginationModule,CommonModule,FormsModule,PageTitleComponent,NgbHighlight,NgbdSortableHeader],
...
export class DatatableComponent {
  ...
  refreshSearchCountries() {
    this.searchCountries = DataTableItems
      .map((country:any) => ({
        ...country,
      }))
      .slice(
